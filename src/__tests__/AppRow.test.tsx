...
describe('AppRow', () => {
  it('shows Launch button when installed and up to date', () => {
    render(<AppRow state={baseState} onAction={vi.fn()} onInfo={vi.fn()} />)
  ...
  it('shows Update button when newer version available', () => {
    ...
    render(<AppRow state={state} onAction={vi.fn()} onInfo={vi.fn()} />)
  ...
  it('calls onAction with launch when Launch is clicked', () => {
    ...
    render(<AppRow state={baseState} onAction={onAction} onInfo={vi.fn()} />)
